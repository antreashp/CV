...
%             for kk = 1:length(psis)
%                 for mm = 1:length(gammas)
...
fprintf('Number of sigmas (sigma): %d \n', length(sigmas));
fprintf('Number of gammas (gamma)   : %d \n', length(gammas));
fprintf('--------------------------------------\n');
